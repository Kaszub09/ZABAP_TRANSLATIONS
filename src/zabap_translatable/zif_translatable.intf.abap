INTERFACE zif_translatable PUBLIC.
  ...
  METHODS:
    "! <p class="shorttext synchronized">Existing texts are re-read and synchronized to SAP</p>
    read_language IMPORTING sap_lang TYPE sy-langu,
    "! <p class="shorttext synchronized">Returns all texts read and/or modified</p>
    get_all_texts RETURNING VALUE(texts) TYPE tt_text,
    "! @parameter new_texts | <p class="shorttext synchronized">Texts with different object type/name are skipped</p>
    modify_texts IMPORTING new_texts TYPE tt_text,
    "! <p class="shorttext synchronized">Save read and/or modified texts in database</p>
